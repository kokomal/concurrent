 ...
 * @date: 2018年9月4日 下午3:01:37
 */
public class GenericResponseDecoder extends ByteToMessageDecoder {
    /**
     * 数据包基本长度
     */
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
        ...
        if (in.readableBytes() >= BASE_LENGTH) {
            System.out.println("GenericResponseDecoder incoming data size = " + in.readableBytes());
            // 防止socket字节流攻击
            ...
            in.readBytes(data);
            GenericResponseDto request = new GenericResponseDto();
