 ...
 * @date: 2018年9月4日 下午3:16:39
 */
public class GenericResponseEncoder extends MessageToByteEncoder<GenericResponseDto> {
    @Override
    protected void encode(ChannelHandlerContext ctx, GenericResponseDto msg, ByteBuf out) throws Exception {
        // 包头
