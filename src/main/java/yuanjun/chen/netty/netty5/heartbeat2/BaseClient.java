 ...
 * @Description: 采用IdleStateHandler对client的写idle进行绑定，如果被server踢掉，则递归connect再度连接！
 * @author: 陈元俊
 * @SpecialThanksTo: BazingaLyn
 * @date: 2018年9月13日 上午10:56:37
 */
public class BaseClient {
    ...
    public void connect(int port, String host) throws Exception {
        ...
        try {
            ...
            connect(port, host);
            System.out.println("重连成功"); // 其实基本上跑不到这里
        }
    }
